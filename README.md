...
- There will be several weekly homework assignments and one final project. For each assignment:
...
### Guest Speaker: Kit Kuksenok

- [p5.js Community Statement](https://p5js.org/about/#community-statement)
- [p5.js Access Statement](https://p5js.org/contribute/access/)
- [p5.js Code of Conduct](https://p5js.org/code-of-conduct/)
...
Please read and review the [ITP/IMA Community Guidelines](https://community.itp.io).
...
The course will be once per week for 2.5 hours for a total of seven weeks.
...
There will be assignments that are relevant to the class material. The primary elements of the assignments is documentation (written description, photos, screenshots, screen recording, code, and video all qualify based on the assignment) of your process. Each assignment is due by class time one week after they are assigned unless stated otherwise.

It is expected that you will spend 2 to 4 hours a week on the class outside of class itself. This will include reviewing material, reading, watching video, completing assignments and so on. Please budget your time accordingly.
...
After the first two weeks of the add/drop period, effective in week three onward, students are permitted the following number of absences: 2 absences. There are no excused absences and unexcused absences. There are only absences. Any more than 2 absences will affect your grade, please see the makeup work policy below.
